...
type MockPlugin struct {
	MapFn    func(ctx context.Context, db string, call *pql.Call, slice uint64) (interface{}, error)
...
func (p *MockPlugin) Map(ctx context.Context, db string, call *pql.Call, slice uint64) (interface{}, error) {
	return p.MapFn(ctx, db, call, slice)
}
